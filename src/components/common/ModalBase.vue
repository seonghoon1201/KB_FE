...
<template>
    <div
        class="fixed top-0 right-0 w-[60%] h-screen bg-white border border-black z-50"
        @mousedown="dragStart"
        v-show="modalStore.modal"
    >
        ...
        <div class="h-[30%] pt-4 pb-4 flex flex-col justify-around p-1 border-b-2">
            ...
            <div class="flex justify-start">
                ...
                <div class="w-[30%] flex flex-col items-center mr-3" @click="movePage('/calendar')">
